...
abc_ef      = range(-1,  1, 0.1)             # Range of \E : a-b-c [Endres 2015]
simbox      = { 'a' : a, 'alpha' : alpha } #'n' : n
#-------------------------------------------------SIMULATION BOX SETTINGS,2*5
alpha_r    = alpha * math.pi / 180.0
XY_DELTA   = a * 2 * math.cos( alpha_r )
YZ_DELTA   = a * 5 * math.cos( alpha_r )
XZ_DELTA   = a * 1 * math.cos( alpha_r )
